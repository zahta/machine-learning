...
### :star:  Colab
   ...
   - A good approach to import local datasets into the Colab: :one: Compress the the dataset's folder, e.i., as a `zip` file :two: Upload the compressed file to your Google drive :three: Mount your Google drive into the colab :four: Unzip the compressed file in Colab.
